...
#### 1.10.2 英国🇬🇧
英国CDT/DTP一般在网申后会由admission panel进行shortlist，通过shortlist的申请者会收到后续的面试通知。Shortlist完了进行一次面试，一锤定音。CDT/DTP的面试大多都在一月下旬，也就是春节左右的时间。面试形式可能包含上述所有方式的排列组合，看panel自己的想法。  
