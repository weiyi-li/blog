...
### 1.4 学位等级
XJTLU毕业发中方的毕业证学位证（不分等级）和英方学位证（分等级），我们平时说的几等学位主要是英方学位的等级，由大三和大四的均分(2+2为Year2和Year3)按30%:70%的比例计算等级，70以上为一等荣誉学位，60-69为二等一荣誉学位，50-59为二等二荣誉学位，40-49为三等荣誉学位，其余为通过学位。学位等级是对大三大四学习能力的直接反映，代表大三大四期间对学校授课的掌握。虽然不能定义其他方面的能力比如工作能力，但学位等级在某些场合还是比较重要的。
