...
虽然电气系课程的广度够，但是少数课程的深度对于某些公司EE实习岗位的需求来说略显不足。比如数字电路中的跨时钟域处理，以及稳态与亚稳态等概念在课上的知识点中不一定会提及，但是这些概念是数字IC设计和FPGA设计岗位中的重点概念。EST专业微电子方向的培养方案还是很全面的，包含IC设计、半导体器件和物理、IC制造和工艺以及可选修的光电等等，但是对于芯片公司中广泛存在且较为重要的IC验证岗位来说，验证的基础知识比如UVM验证方法等都没有学到，如果投递相关岗位可能需要额外补齐相关知识。另外，对于电气系全系专业来说，有一门课的缺失有点可惜，就是计算机网络。计网本质上是传输信息的通信网络，不仅属于计算机的专业基础课，也属于通信和网络的相关知识，以CAN开头算入EE的专业课也未尝不可。计网的知识点都是通信、运维、web开发等岗位中非常重要的概念，否则连TCP/IP协议这种网络基础知识都得自学。不过也别指望所有工作的东西在学校里都能学到，有的时候完全是两码事，基础概念和知识掌握扎实，有一定的实践和项目开发经验足矣。  
